...
# IMG_PATH_ORIGINAL = 'images/image1_original.jpeg'
# IMG_PATH ='images/image7.jpeg'
# IMG_PATH_ORIGINAL = 'images/image7_original.jpeg'
IMG_PATH = ""
IMG_PATH_ORIGINAL = ""
...
tree = ET.parse('meter_property1.xml')
root = tree.getroot()
for child in root:
    tag = child.tag
    attrib = child.attrib
...
if DIAL_TYPE == 1 or DIAL_TYPE == 3:
    ...
    # angles = process_top_dials(110, SMALL_ARROW_MIN_AREA, SMALL_ARROW_MAX_AREA,THRESH_ANGLE, K, NUM_SAMPLE_POINTS_SMALL_ARROW, boundaries[3])
    ...
    for angle in angles:
        ...
        if ORIENTATION_OF_FIRST_DIAL == 1:
            print ("   Reading {}: {}".format(i, "%.1f"%(get_reading_top(angle - base_angle, (i+1) % 2))))
        else:
            print ("   Reading {}: {}".format(i, "%.1f"%(get_reading_top(angle - base_angle, i % 2))))
    print ("#"*30, "\n", "#"*30, "\n\n")
...
if DIAL_TYPE == 2 or DIAL_TYPE == 3:
    ...
    print ("*"*30, "\nSTEP 2: LOOKING FOR ANGLES OF THE LONG ARROW ...")
    ...
    print ("READING OF THE BOTTOM DIAL: {}".format("%.1f"%(get_reading_bottom(angle, bottom_dial_bound, BOTTOM_READING_LEFT, BOTTOM_READING_RIGHT, SCALE_TYPE))))
    print ("#"*30, "\n", "#"*30, "\n\n")
